...
def compare_list(input_1_path,input_2_path):
    ...
    dict_1_word_set = set(dict_1_word_list)
    dict_2_word_set = set(dict_2_word_list)
    ...
    write_list(additive_words,'../../result_data/dictionary_compare/bi_additive_words.txt')
    write_list(lack_words,'../../result_data/dictionary_compare/bi_lack_words.txt')
...
#     input_1_path = 'E:/formal_project_java/word_seg/word_seg_develop/src/main/resources/data/finance_dictionary/CoreFinanceDictionary.txt'
    
    input_1_path = '../../result_data/dictionary_compare/additive_words.txt'
    input_2_path = '../../result_data/dictionary_compare/lack_words.txt'
